            ...
            <section class="user-content">
                ...
                <div class="user-data">
                    ...
                    <div class="data">
                        ...
                        <div class="item password"><span class="title">Password: </span><span class="value"><?php echo $data['user_email']; ?></span><a href="<?php echo URLROOT; ?>/users/edit/<?php echo $data['user_id']; ?>" class="btn btn-edit">edit</a></div>
                    </div>
                </div>
            </section>
        </div>
